            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="team-header">
                        <?php if ($header = get_field('team_section_title')): ?>
                            <h2 class="headin-lg"><?php echo esc_html($header); ?></h2>
                        <?php endif; ?>
                        <?php if ($desc = get_field('team_section_desc')): ?>
                            <p class="paragraph c-grey"><?php echo esc_html($desc); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row team-member-row gx-5">
                ...
                if ($team_query->have_posts()):
                    while ($team_query->have_posts()): $team_query->the_post();
                        $title_suffix = get_field('title_suffix');
                ...
                ?>
                        <div class="col-lg-4 col-md-6 offset-md-0 col-10 offset-1">
                            <div class="team-member">
                                ...
                                <figcaption>
                                    <h4 class="heading-sm"><?php the_title(); ?></h4>
